...
👉 Download the **nopCommerce Admin AI Chatbot Plugin** from our store:  
[https://shop.nopaccelerate.com](https://shop.nopaccelerate.com)

**Step 1** : Go to **Administration → Configuration → Local Plugins**.

**Step 2** : Upload the **nopCommerce Admin AI ChatBot plugin** zip file using the **"Upload plugin or theme"** button.

**Step 3** : Restart the application.

**Step 4** : Locate **nopCommerce Admin AI Chatbot** under the **Xcellence-IT** group.
...
[← Previous](2.0.0.3.md) | [Next →](licence.md)
